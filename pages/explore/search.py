...
def search_layout():
    return html.Div([
        ...
        html.P("Enter a PubMed ID, internal study ID, DOI, or part of a title to find matching papers."),

        dbc.Row([
            dbc.Col(dcc.Input(id='search-input', type='text', placeholder='pubmed id, id, doi or title', className='form-control'), width=9),
            dbc.Col(dbc.Button('Search', id='search-button', color='primary', n_clicks=0), width=3),
        ], className='mb-3'),
