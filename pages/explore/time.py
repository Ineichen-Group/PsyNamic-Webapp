    ...
    return html.Div([
        ...
        html.Div([
            html.Div([
                ...
                dcc.Input(id='start-year', type='number', value=1955, min=df['Year'].min(
                ), max=df['Year'].max(), className="form-control year-input"),
            ], className="col-md-3"),

            html.Div([
                html.Label("End Year:", className="form-label pe-4"),
                dcc.Input(id='end-year', type='number', value=current_year, min=df['Year'].min(
                ), max=df['Year'].max(), className="form-control year-input"),
            ], className="col-md-3"),
