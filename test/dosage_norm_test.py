import os
import unittest
from data.dosage_norm import normalize_dosage, extract_dosages, normalize_relative_weight_dosages
...
class DosageExtractTest(unittest.TestCase):
    ...
    # def test_with_slash_sevreal(self):
    #     # 28/56/84 mg
...
class DosageRelativeWeightNormTest(unittest.TestCase):
    def test_normalize_relative_weight_dosages(self):
        ...
        min_val, max_val = normalize_relative_weight_dosages(minv, maxv, dosage, per_weight_unit, factor)
